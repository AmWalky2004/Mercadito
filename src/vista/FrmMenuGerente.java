...
public class FrmMenuGerente extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(FrmMenuGerente.class.getName());
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> new FrmMenuGerente().setVisible(true));
    }
